...
<t:tabs id="tt" iframe="false">
	<t:tab href="jeecgListDemoController.do?rowListDemo" icon="fa fa-line-chart" title="user.analysis.line" id="pnode"></t:tab>
	<t:tab href="jeecgListDemoController.do?rowListDemo" icon="fa fa-pie-chart" title="user.analysis.pie" id="pnode"></t:tab>
	<t:tab href="jeecgListDemoController.do?rowListDemo" icon="fa fa-bar-chart" title="user.analysis.histogram" id="pnode"></t:tab>
</t:tabs>
