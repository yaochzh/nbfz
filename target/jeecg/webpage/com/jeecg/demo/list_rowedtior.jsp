...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="jeecgrowList"  checkbox="true" pagination="true" fitColumns="true"  height = "800"
  title="jeecg_rowedit" actionUrl="jeecgListDemoController.do?datagrid" idField="id"  queryMode="group">
    ...
    <t:dgCol title="名称" colspan="2" rowspan = "4" field="name" query="true" extendParams="editor:'text'" width="150"></t:dgCol>
