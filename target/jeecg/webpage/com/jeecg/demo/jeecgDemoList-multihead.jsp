...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="jeecgDemoList" checkbox="true" sortName="birthday,name" pagination="true" fitColumns="false"
   title="列表多表头例子" actionUrl="jeecgListDemoController.do?datagrid" idField="id" fit="true" queryMode="group">
    ...
    <t:dgCol title="电话"  field="phone" frozenColumn="true" queryMode="group"  width="120"></t:dgCol>
